...
<div class="md:p-6 bg-white md:m-5">
    <div class="flex items-center justify-between">
        ...
        <div>
            <button class="bg-blue-500 text-white w-[160px] h-[50px] rounded-md" id="addBank">
                Add Distributer
            </button>
        </div>
    </div>
    ...
    <form action="#" name="group_by" method="post">
        <button type="submit" name="group_by" class="bg-blue-500 text-white w-[160px] h-[50px] rounded-md">
            Group by Bank
        </button>
    </form>
    ...
    <div class="hidden md:block rounded-lg overflow-hidden mt-10">
        <table class="w-full table-auto" id="table1">
            <thead class="">
                <tr class="bg-blue-500 text-white h-[60px]">
                    <th class="">ID</th>
            ...
            <tbody>
                ...
                <tr class="h-[50px]">
                    ...
                    <td class="text-center">
                        <button class="bg-blue-500 text-white w-[35px] h-[35px] rounded-md" onclick="">
                            <a href=<?php echo "Distributer.php?id=" . $distributer['atmId'] ?>><i
                                    class="fa-solid fa-pen" style="color:#186F65"></i></a>
                        </button>
                        <button class="bg-blue-500 text-white w-[35px] h-[35px] rounded-md" id="addBank">
                            <a
